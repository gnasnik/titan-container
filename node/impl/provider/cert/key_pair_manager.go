...
func NewKeyPairManager(providerId string, homeDir string) (KeyPairManager, error) {
...
func (kpm *keyPairManager) getKeyPath() string {
	return kpm.homeDir + "/" + kpm.providerId + ".pem"
}
...
func (kpm *keyPairManager) generateImpl(notBefore, notAfter time.Time, domains []string, fout io.Writer) error {
	...
	if err = pem.Encode(fout, &pem.Block{Type: PemBlkTypeCertificate, Bytes: certDer}); err != nil {
